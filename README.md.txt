Git - это система контроля версией для хранения истории изменений
Git поможет рабоать в команд  
Инструмент работы Git - по разному называется, терминал, командная строка, Git BASH. Git - Это программа которая устновливается в РС 
в зависмости от системы Windows. Git — это программа, которая в том числе может работать из командной строки. 
